...
wget -nc https://roy.marples.name/downloads/dhcpcd/dhcpcd-8.1.5.tar.xz
wget -nc ftp://roy.marples.name/pub/dhcpcd/dhcpcd-8.1.5.tar.xz


NAME=dhcpcd
VERSION=8.1.5
URL=https://roy.marples.name/downloads/dhcpcd/dhcpcd-8.1.5.tar.xz
