...
wget -nc http://ffmpeg.org/releases/ffmpeg-4.1.2.tar.xz
...
--enable-libx264 \
--enable-libx265 \
--docdir=/usr/share/doc/ffmpeg-4.1.2 &&
...
install -v -m755 -d /usr/share/doc/ffmpeg-4.1.2 &&
install -v -m644 doc/*.txt /usr/share/doc/ffmpeg-4.1.2
ENDOFROOTSCRIPT
