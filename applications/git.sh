...
wget -nc https://www.kernel.org/pub/software/scm/git/git-2.25.0.tar.xz
wget -nc https://www.kernel.org/pub/software/scm/git/git-manpages-2.25.0.tar.xz
wget -nc https://www.kernel.org/pub/software/scm/git/git-htmldocs-2.25.0.tar.xz
...
sudo rm -rf /tmp/rootscript.sh
cat > /tmp/rootscript.sh <<"ENDOFROOTSCRIPT"
mkdir -vp   /usr/share/doc/git-2.25.0 &&
tar   -xf   ../git-htmldocs-2.25.0.tar.xz \
      -C    /usr/share/doc/git-2.25.0 --no-same-owner --no-overwrite-dir &&

find        /usr/share/doc/git-2.25.0 -type d -exec chmod 755 {} \; &&
find        /usr/share/doc/git-2.25.0 -type f -exec chmod 644 {} \;
ENDOFROOTSCRIPT
