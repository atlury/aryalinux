...
DESCRIPTION="The GNOME Menus package contains an implementation of the draft <a class=\ulink\ href=\http://www.freedesktop.org/Standards/menu-spec\>Desktop Menu Specification</a> from freedesktop.org. It also contains the GNOME menu layout configuration files and <code class=\filename\>.directory files."
VERSION=3.32.0
