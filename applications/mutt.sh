...
wget -nc https://bitbucket.org/mutt/mutt/downloads/mutt-1.13.2.tar.gz
wget -nc ftp://ftp.mutt.org/pub/mutt/mutt-1.13.2.tar.gz
...
./configure --prefix=/usr                           \
            --sysconfdir=/etc                       \
            --with-docdir=/usr/share/doc/mutt-1.13.2 \
            --with-ssl                              \
...
test -s doc/manual.txt ||
  ...
  /usr/share/doc/mutt-1.13.2/manual.txt
ENDOFROOTSCRIPT
...
cat /usr/share/doc/mutt-1.13.2/samples/gpg.rc >> ~/.muttrc
