...
wget -nc https://www.nano-editor.org/dist/v4/nano-4.0.tar.xz
...
--sysconfdir=/etc \
--enable-utf8 \
--docdir=/usr/share/doc/nano-4.0 &&
make

sudo rm -rf /tmp/rootscript.sh
cat > /tmp/rootscript.sh <<"ENDOFROOTSCRIPT"
make install &&
install -v -m644 doc/{nano.html,sample.nanorc} /usr/share/doc/nano-4.0
ENDOFROOTSCRIPT
