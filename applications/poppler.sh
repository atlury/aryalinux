...
if [ ! -z $URL ]
then
wget -nc https://poppler.freedesktop.org/poppler-0.68.0.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/poppler/poppler-0.68.0.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/poppler/poppler-0.68.0.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/poppler/poppler-0.68.0.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/poppler/poppler-0.68.0.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/poppler/poppler-0.68.0.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/poppler/poppler-0.68.0.tar.xz
...
sudo tee rootscript.sh << "ENDOFROOTSCRIPT"
install -v -m755 -d           /usr/share/doc/poppler-0.68.0 &&
cp -vr ../glib/reference/html /usr/share/doc/poppler-0.68.0
