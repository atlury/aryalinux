...
wget -nc https://poppler.freedesktop.org/poppler-0.84.0.tar.xz
...
sudo rm -rf /tmp/rootscript.sh
cat > /tmp/rootscript.sh <<"ENDOFROOTSCRIPT"
install -v -m755 -d           /usr/share/doc/poppler-0.84.0 &&
cp -vr ../glib/reference/html /usr/share/doc/poppler-0.84.0
ENDOFROOTSCRIPT
