...
wget -nc http://www.sudo.ws/dist/sudo-1.8.30.tar.gz
wget -nc ftp://ftp.sudo.ws/pub/sudo/sudo-1.8.30.tar.gz


NAME=sudo
VERSION=1.8.30
URL=http://www.sudo.ws/dist/sudo-1.8.30.tar.gz
SECTION="Security"
...
./configure --prefix=/usr              \
            ...
            --with-all-insults         \
            --with-env-editor          \
            --docdir=/usr/share/doc/sudo-1.8.30 \
