...
wget -nc https://archive.mozilla.org/pub/thunderbird/releases/68.4.1/source/thunderbird-68.4.1.source.tar.xz


NAME=thunderbird
VERSION=68.4.1
URL=https://archive.mozilla.org/pub/thunderbird/releases/68.4.1/source/thunderbird-68.4.1.source.tar.xz
