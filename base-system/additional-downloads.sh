...
wget -nc https://bitbucket.org/chandrakantsingh/patches/raw/1.2/grub-2.02-bintuils.patch
...
wget -nc https://bitbucket.org/chandrakantsingh/patches/raw/1.2/aufs4-standalone.patch
